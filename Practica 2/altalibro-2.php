    ...
    <section id="registro-libro">
        ...
        <article>
          ...
          <form action="nuevoLibro.php" method="POST" enctype = "multipart/form-data">
              ...
              <span> El ISBN introducido ya pertenece a otro libro. </span>
              <br>
              <label class="anadir-libro2" for="titulo-libro"> TITULO </label>
              <input type="text" name="titulo" id="titulo-libro" value=<?php echo $_COOKIE["titulo"]?> onblur="comprobarTitulo()" required/>
              <br>
              <label class="anadir-libro2" for="autor-libro"> AUTOR </label>
              <input type="text" name="autor" id="autor-libro" value=<?php echo $_COOKIE["autor"]?> onblur="comprobarAutor()" required/>
              ...
              <input type="text" name="editorial" id="editorial-libro" list="listaEditorial" value=<?php echo $_COOKIE["editorial"]?> onblur="comprobarEditorial()" required/>

              <br>
              <label class="anadir-libro2" for="anyo-libro"> A&Ntilde;O </label>
              <input type="number" name="anyo" id="anyo-libro" value=<?php echo $_COOKIE["anyo"]?> onblur="comprobarAnyo()" required/>
              <br>
              <label class="anadir-libro2" for="edicion-libro"> EDICION </label>
              <input type="text" name="edicion" id="edicion-libro" value=<?php echo $_COOKIE["edicion"]?> onblur="comprobarEdicion()" required/>
            ...
            <fieldset>
              ...
              <label class="anadir-libro" for="descripcion-libro">
                <textarea name="descripcion" id="descripcion-libro" rows="4" cols="75" maxlength="300" value=<?php echo $_COOKIE["descripcion"]?> onkeyup="contarDescripcion()" required></textarea>
            ...
            <fieldset>
              ...
              <label class="anadir-libro" for="opinion-libro">
                <textarea name="opinion" id="opinion-libro" rows="4" cols="75" maxlength="350" value=<?php echo $_COOKIE["opinion"]?> onkeyup="contarOpinion()" required></textarea>
